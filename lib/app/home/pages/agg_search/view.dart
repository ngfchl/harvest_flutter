...
class _AggSearchPageState extends State<AggSearchPage> with AutomaticKeepAliveClientMixin {
    ...
    return GetBuilder<AggSearchController>(
      ...
      builder: (controller) {
        ...
        return GetBuilder<AggSearchController>(builder: (controller) {
                    ...
                    child: ShadTabs(
                        ...
                        tabs: [
                          ShadTab(
                            ...
                            child: Text(
                              '影视查询${controller.selectedWarehouse.isEmpty ? '' : '「${controller.selectedWarehouse}」'}',
                          ...
                          ShadTab(
                            ...
                            content: Column(
                              children: [
                                                  ...
                                                  children: [
                                                    if (controller.isLoading) ...[
                                                      ...
                                                      Text(
                                                        '搜索中',
                                                        style:
                                                            TextStyle(fontSize: 12, color: shadColorScheme.foreground),
                                                      )
                                                    ],
                                                    Text(
                                ...
                                if (controller.showResults.isNotEmpty)
                                  Expanded(
                                    child: ListView.builder(
                                      itemCount: controller.showResults.length,
                                      itemBuilder: (BuildContext context, int index) {
                                        SearchTorrentInfo info = controller.showResults[index];
                                        return RepaintBoundary(child: showTorrentInfo(info));
                                      },
                                    ),
                                  ),
                              ],
                            ),
                            child: Text('资源搜索', style: const TextStyle(fontSize: 13)),
                          ),
                          ShadTab(
                            value: '历史',
                                                    ...
                                                    confirm: ShadButton.destructive(
                                                      ...
                                                      onPressed: () {
                                                        ...
                                                        SPUtil.setStringList(
                                                            'search_history', controller.searchHistory);
                                                        controller.update();
                                                        Get.back();
                                                      },
                                                      child: Text('确定',
          ...
          if (PlatformTool.isSmallScreenPortrait()) {
          ...
          return SafeArea(
            ...
            child: Scaffold(
              ...
              floatingActionButton:
                  controller.searchResults.isNotEmpty && controller.tabsController.selected == 'agg_search'
  ...
  Widget _buildBottomButtonBar() {
    ...
    return Column(
      ...
      children: [
        ...
        if (PlatformTool.isSmallScreenPortrait()) SizedBox(height: 60),
      ],
    );
  }
  ...
  void _buildOperateDialog(DouBanSearchResult mediaInfo) {
    controller.getSubjectInfo(mediaInfo.target.id);
    var shadColorScheme = ShadTheme.of(context).colorScheme;
    Get.bottomSheet(
  ...
  Widget showDouBanSearchInfo(DouBanSearchResult info) {
    var shadColorScheme = ShadTheme.of(context).colorScheme;
    return InkWell(
      onTap: () => _buildOperateDialog(info),
      onDoubleTap: () async {
        ...
        startActionPane: ActionPane(
          ...
          children: [
            SlidableAction(
              ...
              onPressed: (context) => _buildOperateDialog(info),
