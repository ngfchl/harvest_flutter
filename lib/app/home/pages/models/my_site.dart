...
class StatusInfo {
  ...
  factory StatusInfo.fromJson(Map<String, dynamic> json) {
    return StatusInfo(
      ...
      myBonus: double.parse(json['my_bonus']?.toString() ?? '0.0'),
      myScore: double.parse(json['my_score']?.toString() ?? '0.0'),
      bonusHour: double.parse(json['bonus_hour']?.toString() ?? '0.0'),
      seed: json['seed'] as int? ?? 0,
      leech: json['leech'] as int? ?? 0,
