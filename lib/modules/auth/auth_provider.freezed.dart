...
mixin _$AuthState {
 ...
 bool get loading; bool get loggedIn; String? get accessToken; String? get refreshToken; User? get user;
...
@useResult
$Res call({
 bool loading, bool loggedIn, String? accessToken, String? refreshToken, User? user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool loading,  bool loggedIn,  String? accessToken,  String? refreshToken,  User? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.loading,_that.loggedIn,_that.accessToken,_that.refreshToken,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool loading,  bool loggedIn,  String? accessToken,  String? refreshToken,  User? user)  $default,) {final _that = this;
switch (_that) {
case _AuthState():
return $default(_that.loading,_that.loggedIn,_that.accessToken,_that.refreshToken,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool loading,  bool loggedIn,  String? accessToken,  String? refreshToken,  User? user)?  $default,) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.loading,_that.loggedIn,_that.accessToken,_that.refreshToken,_that.user);case _:
  return null;
...
class _AuthState implements AuthState {
  const _AuthState({this.loading = false, this.loggedIn = false, this.accessToken, this.refreshToken, this.user});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? loading = null,Object? loggedIn = null,Object? accessToken = freezed,Object? refreshToken = freezed,Object? user = freezed,}) {
