...
class TorrentTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void showDetail() => showModalBottomSheet(
      context: context,
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  Text(TorrentUtils.formatTimeAgo(torrent.activityDate))
                      .xSmall
                      .muted,
                ],
              ),
  ...
  int _remainingBytes(Torrent torrent) {
    ...
    final total =
    torrent.sizeWhenDone > 0 ? torrent.sizeWhenDone : torrent.totalSize;
    if (total <= 0) return 0;
  ...
  String? _etaText(Torrent torrent, int remainingBytes) {
    ...
    final isDownloading = status == TorrentStatus.downloading ||
