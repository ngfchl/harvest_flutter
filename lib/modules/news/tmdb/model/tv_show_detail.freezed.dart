...
bool operator ==(Object other) {
  final _this = this as TvShowDetail;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TvShowDetail&&(identical(other.adult, _this.adult) || other.adult == _this.adult)&&(identical(other.backdropPath, _this.backdropPath) || other.backdropPath == _this.backdropPath)&&const DeepCollectionEquality().equals(other.createdBy, _this.createdBy)&&const DeepCollectionEquality().equals(other.episodeRunTime, _this.episodeRunTime)&&(identical(other.releaseDate, _this.releaseDate) || other.releaseDate == _this.releaseDate)&&const DeepCollectionEquality().equals(other.genres, _this.genres)&&(identical(other.homepage, _this.homepage) || other.homepage == _this.homepage)&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.imdbId, _this.imdbId) || other.imdbId == _this.imdbId)&&(identical(other.mediaType, _this.mediaType) || other.mediaType == _this.mediaType)&&(identical(other.inProduction, _this.inProduction) || other.inProduction == _this.inProduction)&&const DeepCollectionEquality().equals(other.languages, _this.languages)&&(identical(other.lastAirDate, _this.lastAirDate) || other.lastAirDate == _this.lastAirDate)&&(identical(other.lastEpisodeToAir, _this.lastEpisodeToAir) || other.lastEpisodeToAir == _this.lastEpisodeToAir)&&(identical(other.title, _this.title) || other.title == _this.title)&&const DeepCollectionEquality().equals(other.nextEpisodeToAir, _this.nextEpisodeToAir)&&const DeepCollectionEquality().equals(other.networks, _this.networks)&&(identical(other.numberOfEpisodes, _this.numberOfEpisodes) || other.numberOfEpisodes == _this.numberOfEpisodes)&&(identical(other.numberOfSeasons, _this.numberOfSeasons) || other.numberOfSeasons == _this.numberOfSeasons)&&const DeepCollectionEquality().equals(other.originCountry, _this.originCountry)&&(identical(other.originalLanguage, _this.originalLanguage) || other.originalLanguage == _this.originalLanguage)&&(identical(other.originalTitle, _this.originalTitle) || other.originalTitle == _this.originalTitle)&&(identical(other.overview, _this.overview) || other.overview == _this.overview)&&(identical(other.popularity, _this.popularity) || other.popularity == _this.popularity)&&(identical(other.posterPath, _this.posterPath) || other.posterPath == _this.posterPath)&&const DeepCollectionEquality().equals(other.productionCompanies, _this.productionCompanies)&&const DeepCollectionEquality().equals(other.productionCountries, _this.productionCountries)&&const DeepCollectionEquality().equals(other.seasons, _this.seasons)&&const DeepCollectionEquality().equals(other.spokenLanguages, _this.spokenLanguages)&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.tagline, _this.tagline) || other.tagline == _this.tagline)&&(identical(other.type, _this.type) || other.type == _this.type)&&(identical(other.voteAverage, _this.voteAverage) || other.voteAverage == _this.voteAverage)&&(identical(other.voteCount, _this.voteCount) || other.voteCount == _this.voteCount));
}
...
int get hashCode {
  final _this = this as TvShowDetail;
  return Object.hashAll([runtimeType,_this.adult,_this.backdropPath,const DeepCollectionEquality().hash(_this.createdBy),const DeepCollectionEquality().hash(_this.episodeRunTime),_this.releaseDate,const DeepCollectionEquality().hash(_this.genres),_this.homepage,_this.id,_this.imdbId,_this.mediaType,_this.inProduction,const DeepCollectionEquality().hash(_this.languages),_this.lastAirDate,_this.lastEpisodeToAir,_this.title,const DeepCollectionEquality().hash(_this.nextEpisodeToAir),const DeepCollectionEquality().hash(_this.networks),_this.numberOfEpisodes,_this.numberOfSeasons,const DeepCollectionEquality().hash(_this.originCountry),_this.originalLanguage,_this.originalTitle,_this.overview,_this.popularity,_this.posterPath,const DeepCollectionEquality().hash(_this.productionCompanies),const DeepCollectionEquality().hash(_this.productionCountries),const DeepCollectionEquality().hash(_this.seasons),const DeepCollectionEquality().hash(_this.spokenLanguages),_this.status,_this.tagline,_this.type,_this.voteAverage,_this.voteCount]);
}

@override
String toString() {
  final _this = this as TvShowDetail;
  return 'TvShowDetail(adult: ${_this.adult}, backdropPath: ${_this.backdropPath}, createdBy: ${_this.createdBy}, episodeRunTime: ${_this.episodeRunTime}, releaseDate: ${_this.releaseDate}, genres: ${_this.genres}, homepage: ${_this.homepage}, id: ${_this.id}, imdbId: ${_this.imdbId}, mediaType: ${_this.mediaType}, inProduction: ${_this.inProduction}, languages: ${_this.languages}, lastAirDate: ${_this.lastAirDate}, lastEpisodeToAir: ${_this.lastEpisodeToAir}, title: ${_this.title}, nextEpisodeToAir: ${_this.nextEpisodeToAir}, networks: ${_this.networks}, numberOfEpisodes: ${_this.numberOfEpisodes}, numberOfSeasons: ${_this.numberOfSeasons}, originCountry: ${_this.originCountry}, originalLanguage: ${_this.originalLanguage}, originalTitle: ${_this.originalTitle}, overview: ${_this.overview}, popularity: ${_this.popularity}, posterPath: ${_this.posterPath}, productionCompanies: ${_this.productionCompanies}, productionCountries: ${_this.productionCountries}, seasons: ${_this.seasons}, spokenLanguages: ${_this.spokenLanguages}, status: ${_this.status}, tagline: ${_this.tagline}, type: ${_this.type}, voteAverage: ${_this.voteAverage}, voteCount: ${_this.voteCount})';
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _TvShowDetail&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other.createdBy, _createdBy)&&const DeepCollectionEquality().equals(other.episodeRunTime, _episodeRunTime)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&const DeepCollectionEquality().equals(other.genres, _genres)&&(identical(other.homepage, homepage) || other.homepage == homepage)&&(identical(other.id, id) || other.id == id)&&(identical(other.imdbId, imdbId) || other.imdbId == imdbId)&&(identical(other.mediaType, mediaType) || other.mediaType == mediaType)&&(identical(other.inProduction, inProduction) || other.inProduction == inProduction)&&const DeepCollectionEquality().equals(other.languages, _languages)&&(identical(other.lastAirDate, lastAirDate) || other.lastAirDate == lastAirDate)&&(identical(other.lastEpisodeToAir, lastEpisodeToAir) || other.lastEpisodeToAir == lastEpisodeToAir)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.nextEpisodeToAir, nextEpisodeToAir)&&const DeepCollectionEquality().equals(other.networks, _networks)&&(identical(other.numberOfEpisodes, numberOfEpisodes) || other.numberOfEpisodes == numberOfEpisodes)&&(identical(other.numberOfSeasons, numberOfSeasons) || other.numberOfSeasons == numberOfSeasons)&&const DeepCollectionEquality().equals(other.originCountry, _originCountry)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&const DeepCollectionEquality().equals(other.productionCompanies, _productionCompanies)&&const DeepCollectionEquality().equals(other.productionCountries, _productionCountries)&&const DeepCollectionEquality().equals(other.seasons, _seasons)&&const DeepCollectionEquality().equals(other.spokenLanguages, _spokenLanguages)&&(identical(other.status, status) || other.status == status)&&(identical(other.tagline, tagline) || other.tagline == tagline)&&(identical(other.type, type) || other.type == type)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hashAll([runtimeType,adult,backdropPath,const DeepCollectionEquality().hash(_createdBy),const DeepCollectionEquality().hash(_episodeRunTime),releaseDate,const DeepCollectionEquality().hash(_genres),homepage,id,imdbId,mediaType,inProduction,const DeepCollectionEquality().hash(_languages),lastAirDate,lastEpisodeToAir,title,const DeepCollectionEquality().hash(nextEpisodeToAir),const DeepCollectionEquality().hash(_networks),numberOfEpisodes,numberOfSeasons,const DeepCollectionEquality().hash(_originCountry),originalLanguage,originalTitle,overview,popularity,posterPath,const DeepCollectionEquality().hash(_productionCompanies),const DeepCollectionEquality().hash(_productionCountries),const DeepCollectionEquality().hash(_seasons),const DeepCollectionEquality().hash(_spokenLanguages),status,tagline,type,voteAverage,voteCount]);
}
...
int get hashCode {
  final _this = this as Season;
  return Object.hash(runtimeType,_this.airDate,_this.episodeCount,_this.id,_this.name,_this.overview,_this.posterPath,_this.seasonNumber,_this.voteAverage);
}

@override
String toString() {
  final _this = this as Season;
  return 'Season(airDate: ${_this.airDate}, episodeCount: ${_this.episodeCount}, id: ${_this.id}, name: ${_this.name}, overview: ${_this.overview}, posterPath: ${_this.posterPath}, seasonNumber: ${_this.seasonNumber}, voteAverage: ${_this.voteAverage})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,airDate,episodeCount,id,name,overview,posterPath,seasonNumber,voteAverage);
}
...
@override
bool operator ==(Object other) {
  final _this = this as LastEpisodeToAir;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LastEpisodeToAir&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.overview, _this.overview) || other.overview == _this.overview)&&(identical(other.voteAverage, _this.voteAverage) || other.voteAverage == _this.voteAverage)&&(identical(other.voteCount, _this.voteCount) || other.voteCount == _this.voteCount)&&(identical(other.airDate, _this.airDate) || other.airDate == _this.airDate)&&(identical(other.episodeNumber, _this.episodeNumber) || other.episodeNumber == _this.episodeNumber)&&(identical(other.episodeType, _this.episodeType) || other.episodeType == _this.episodeType)&&(identical(other.productionCode, _this.productionCode) || other.productionCode == _this.productionCode)&&const DeepCollectionEquality().equals(other.runtime, _this.runtime)&&(identical(other.seasonNumber, _this.seasonNumber) || other.seasonNumber == _this.seasonNumber)&&(identical(other.showId, _this.showId) || other.showId == _this.showId)&&const DeepCollectionEquality().equals(other.stillPath, _this.stillPath));
}
...
int get hashCode {
  final _this = this as LastEpisodeToAir;
  return Object.hash(runtimeType,_this.id,_this.name,_this.overview,_this.voteAverage,_this.voteCount,_this.airDate,_this.episodeNumber,_this.episodeType,_this.productionCode,const DeepCollectionEquality().hash(_this.runtime),_this.seasonNumber,_this.showId,const DeepCollectionEquality().hash(_this.stillPath));
}

@override
String toString() {
  final _this = this as LastEpisodeToAir;
  return 'LastEpisodeToAir(id: ${_this.id}, name: ${_this.name}, overview: ${_this.overview}, voteAverage: ${_this.voteAverage}, voteCount: ${_this.voteCount}, airDate: ${_this.airDate}, episodeNumber: ${_this.episodeNumber}, episodeType: ${_this.episodeType}, productionCode: ${_this.productionCode}, runtime: ${_this.runtime}, seasonNumber: ${_this.seasonNumber}, showId: ${_this.showId}, stillPath: ${_this.stillPath})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,name,overview,voteAverage,voteCount,airDate,episodeNumber,episodeType,productionCode,const DeepCollectionEquality().hash(runtime),seasonNumber,showId,const DeepCollectionEquality().hash(stillPath));
}
