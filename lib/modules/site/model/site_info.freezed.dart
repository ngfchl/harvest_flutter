...
int get hashCode {
  final _this = this as SiteInfo;
  return Object.hashAll([runtimeType,_this.id,_this.site,_this.nickname,_this.sortId,const DeepCollectionEquality().hash(_this.tags),_this.userId,_this.username,_this.email,_this.passkey,_this.authkey,_this.cookie,_this.localStorage,_this.userAgent,_this.rss,_this.torrents,_this.available,_this.signIn,_this.getInfo,_this.repeatTorrents,_this.brushFree,_this.brushRss,_this.packageFile,_this.hrDiscern,_this.searchTorrents,_this.showInDash,_this.proxy,const DeepCollectionEquality().hash(_this.removeTorrentRules),_this.mirror,_this.timeJoin,_this.latestActive,_this.mail,_this.notice,const DeepCollectionEquality().hash(_this.signInfo),const DeepCollectionEquality().hash(_this.status),_this.updatedAt]);
}

@override
String toString() {
  final _this = this as SiteInfo;
  return 'SiteInfo(id: ${_this.id}, site: ${_this.site}, nickname: ${_this.nickname}, sortId: ${_this.sortId}, tags: ${_this.tags}, userId: ${_this.userId}, username: ${_this.username}, email: ${_this.email}, passkey: ${_this.passkey}, authkey: ${_this.authkey}, cookie: ${_this.cookie}, localStorage: ${_this.localStorage}, userAgent: ${_this.userAgent}, rss: ${_this.rss}, torrents: ${_this.torrents}, available: ${_this.available}, signIn: ${_this.signIn}, getInfo: ${_this.getInfo}, repeatTorrents: ${_this.repeatTorrents}, brushFree: ${_this.brushFree}, brushRss: ${_this.brushRss}, packageFile: ${_this.packageFile}, hrDiscern: ${_this.hrDiscern}, searchTorrents: ${_this.searchTorrents}, showInDash: ${_this.showInDash}, proxy: ${_this.proxy}, removeTorrentRules: ${_this.removeTorrentRules}, mirror: ${_this.mirror}, timeJoin: ${_this.timeJoin}, latestActive: ${_this.latestActive}, mail: ${_this.mail}, notice: ${_this.notice}, signInfo: ${_this.signInfo}, status: ${_this.status}, updatedAt: ${_this.updatedAt})';
}
...
class _SiteInfo extends SiteInfo {
  const _SiteInfo({this.id = 0, this.site = '', this.nickname = '', @JsonKey(name: 'sort_id') this.sortId = 0,  List<String> tags = const [], @JsonKey(name: 'user_id') this.userId, this.username, this.email, this.passkey, this.authkey, this.cookie, @JsonKey(name: 'local_storage', readValue: _readLocalStorage, fromJson: _localStorageFromJson) this.localStorage, @JsonKey(name: 'user_agent') this.userAgent, this.rss, this.torrents, this.available = false, @JsonKey(name: 'sign_in') this.signIn = false, @JsonKey(name: 'get_info') this.getInfo = false, @JsonKey(name: 'repeat_torrents') this.repeatTorrents = false, @JsonKey(name: 'brush_free') this.brushFree = false, @JsonKey(name: 'brush_rss') this.brushRss = false, @JsonKey(name: 'package_file') this.packageFile = false, @JsonKey(name: 'hr_discern') this.hrDiscern = false, @JsonKey(name: 'search_torrents') this.searchTorrents = false, @JsonKey(name: 'show_in_dash') this.showInDash = true, this.proxy,  Map<String, dynamic> removeTorrentRules = const {}, this.mirror, @JsonKey(name: 'time_join') this.timeJoin, @JsonKey(name: 'latest_active') this.latestActive, this.mail = 0, this.notice = 0, @JsonKey(name: 'sign_info')  Map<String, dynamic>? signInfo, @JsonKey(fromJson: _statusFromJson)  Map<String, SiteDailyStatus>? status, @JsonKey(name: 'updated_at') this.updatedAt}): _tags = tags,_removeTorrentRules = removeTorrentRules,_signInfo = signInfo,_status = status,super._();
...
@override
bool operator ==(Object other) {
  final _this = this as SiteDailyStatus;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SiteDailyStatus&&(identical(other.date, _this.date) || other.date == _this.date)&&(identical(other.seed, _this.seed) || other.seed == _this.seed)&&(identical(other.leech, _this.leech) || other.leech == _this.leech)&&(identical(other.myHr, _this.myHr) || other.myHr == _this.myHr)&&(identical(other.ratio, _this.ratio) || other.ratio == _this.ratio)&&(identical(other.publish, _this.publish) || other.publish == _this.publish)&&(identical(other.myBonus, _this.myBonus) || other.myBonus == _this.myBonus)&&(identical(other.myLevel, _this.myLevel) || other.myLevel == _this.myLevel)&&(identical(other.myScore, _this.myScore) || other.myScore == _this.myScore)&&(identical(other.uploaded, _this.uploaded) || other.uploaded == _this.uploaded)&&(identical(other.seedDays, _this.seedDays) || other.seedDays == _this.seedDays)&&(identical(other.bonusHour, _this.bonusHour) || other.bonusHour == _this.bonusHour)&&(identical(other.created_at, _this.created_at) || other.created_at == _this.created_at)&&(identical(other.downloaded, _this.downloaded) || other.downloaded == _this.downloaded)&&(identical(other.invitation, _this.invitation) || other.invitation == _this.invitation)&&(identical(other.updated_at, _this.updated_at) || other.updated_at == _this.updated_at)&&(identical(other.seedVolume, _this.seedVolume) || other.seedVolume == _this.seedVolume));
}
...
int get hashCode {
  final _this = this as SiteDailyStatus;
  return Object.hash(runtimeType,_this.date,_this.seed,_this.leech,_this.myHr,_this.ratio,_this.publish,_this.myBonus,_this.myLevel,_this.myScore,_this.uploaded,_this.seedDays,_this.bonusHour,_this.created_at,_this.downloaded,_this.invitation,_this.updated_at,_this.seedVolume);
}

@override
String toString() {
  final _this = this as SiteDailyStatus;
  return 'SiteDailyStatus(date: ${_this.date}, seed: ${_this.seed}, leech: ${_this.leech}, myHr: ${_this.myHr}, ratio: ${_this.ratio}, publish: ${_this.publish}, myBonus: ${_this.myBonus}, myLevel: ${_this.myLevel}, myScore: ${_this.myScore}, uploaded: ${_this.uploaded}, seedDays: ${_this.seedDays}, bonusHour: ${_this.bonusHour}, created_at: ${_this.created_at}, downloaded: ${_this.downloaded}, invitation: ${_this.invitation}, updated_at: ${_this.updated_at}, seedVolume: ${_this.seedVolume})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,date,seed,leech,myHr,ratio,publish,myBonus,myLevel,myScore,uploaded,seedDays,bonusHour,created_at,downloaded,invitation,updated_at,seedVolume);
}
