...
class _QbSettingsDialogState extends ConsumerState<QbSettingsDialog> {
  ...
  // ── helpers ──
  Widget _sec(FThemeData t, String s) => Padding(
  ...
  Widget _sw(String title, bool v, ValueChanged<bool> fn) => FTile(
    title: Text(title, style: const TextStyle(fontSize: 13)),
    suffix: FSwitch(value: v, onChange: fn),
  );
  ...
  Widget _sel(
    ...
    suffix: FSelect<String>(
      ...
      format: (s) => s,
      onChange: fn,
      children: opts.map((o) => FSelectItem(o, o)).toList(),
    ),
  );

  Widget _note(FThemeData t, String s) => Padding(
  ...
  // ━━━━━━━━━━━━━ 行为 ━━━━━━━━━━━━━
  Widget _behaviorContent(FThemeData t) => Column(
  ...
  // ━━━━━━━━━━━━━ 下载 ━━━━━━━━━━━━━
  Widget _downloadContent(FThemeData t) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      _sec(t, '添加 Torrent 时'),
      _sel(
  ...
  // ━━━━━━━━━━━━━ 连接 ━━━━━━━━━━━━━
  Widget _connectionContent(FThemeData t) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      _sec(t, '监听端口'),
  ...
  // ━━━━━━━━━━━━━ 速度 ━━━━━━━━━━━━━
  Widget _speedContent(FThemeData t) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      _sec(t, '全局速度限制'),
  ...
  // ━━━━━━━━━━━━━ BitTorrent ━━━━━━━━━━━━━
  Widget _btContent(FThemeData t) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      _sec(t, '隐私'),
  ...
  // ━━━━━━━━━━━━━ RSS ━━━━━━━━━━━━━
  Widget _rssContent(FThemeData t) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      _sec(t, 'RSS 阅读器'),
      _sw(
  ...
  // ━━━━━━━━━━━━━ WebUI ━━━━━━━━━━━━━
  Widget _webUiContent(FThemeData t) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
  ...
  // ━━━━━━━━━━━━━ 高级 ━━━━━━━━━━━━━
  Widget _advancedContent(FThemeData t) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(
                            FIcons.circleAlert,
                            size: 32,
                            color: t.colors.mutedForeground.withValues(
                              alpha: 0.3,
                            ),
                          ),
                          const SizedBox(height: 8),
    ...
    child: FAccordion(
      children: [
        FAccordionItem(
          ...
          title: const Text('行为'),
          child: _behaviorContent(t),
        ),
        FAccordionItem(
          initiallyExpanded: widget.initialIndex == 1,
          title: const Text('下载'),
          child: _downloadContent(t),
        ),
        FAccordionItem(
          initiallyExpanded: widget.initialIndex == 2,
          title: const Text('连接'),
          child: _connectionContent(t),
        ),
        FAccordionItem(
          initiallyExpanded: widget.initialIndex == 3,
          title: const Text('速度'),
          child: _speedContent(t),
        ),
        FAccordionItem(
          initiallyExpanded: widget.initialIndex == 4,
          title: const Text('BitTorrent'),
          child: _btContent(t),
        ),
        FAccordionItem(
          initiallyExpanded: widget.initialIndex == 5,
          title: const Text('RSS'),
          child: _rssContent(t),
        ),
        FAccordionItem(
          initiallyExpanded: widget.initialIndex == 6,
          title: const Text('WebUI'),
          child: _webUiContent(t),
        ),
        FAccordionItem(
          initiallyExpanded: widget.initialIndex == 7,
          title: const Text('高级'),
          child: _advancedContent(t),
        ),
      ],
    ),
  );
