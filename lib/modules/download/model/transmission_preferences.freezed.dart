...
bool operator ==(Object other) {
  final _this = this as TransmissionPreferences;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TransmissionPreferences&&(identical(other.rpcVersion, _this.rpcVersion) || other.rpcVersion == _this.rpcVersion)&&(identical(other.rpcVersionSemver, _this.rpcVersionSemver) || other.rpcVersionSemver == _this.rpcVersionSemver)&&(identical(other.rpcVersionMinimum, _this.rpcVersionMinimum) || other.rpcVersionMinimum == _this.rpcVersionMinimum)&&(identical(other.version, _this.version) || other.version == _this.version)&&(identical(other.altSpeedDown, _this.altSpeedDown) || other.altSpeedDown == _this.altSpeedDown)&&(identical(other.altSpeedEnabled, _this.altSpeedEnabled) || other.altSpeedEnabled == _this.altSpeedEnabled)&&(identical(other.altSpeedTimeBegin, _this.altSpeedTimeBegin) || other.altSpeedTimeBegin == _this.altSpeedTimeBegin)&&(identical(other.altSpeedTimeDay, _this.altSpeedTimeDay) || other.altSpeedTimeDay == _this.altSpeedTimeDay)&&(identical(other.altSpeedTimeEnabled, _this.altSpeedTimeEnabled) || other.altSpeedTimeEnabled == _this.altSpeedTimeEnabled)&&(identical(other.altSpeedTimeEnd, _this.altSpeedTimeEnd) || other.altSpeedTimeEnd == _this.altSpeedTimeEnd)&&(identical(other.altSpeedUp, _this.altSpeedUp) || other.altSpeedUp == _this.altSpeedUp)&&(identical(other.antiBruteForceEnabled, _this.antiBruteForceEnabled) || other.antiBruteForceEnabled == _this.antiBruteForceEnabled)&&(identical(other.antiBruteForceThreshold, _this.antiBruteForceThreshold) || other.antiBruteForceThreshold == _this.antiBruteForceThreshold)&&(identical(other.blocklistEnabled, _this.blocklistEnabled) || other.blocklistEnabled == _this.blocklistEnabled)&&(identical(other.blocklistSize, _this.blocklistSize) || other.blocklistSize == _this.blocklistSize)&&(identical(other.blocklistUrl, _this.blocklistUrl) || other.blocklistUrl == _this.blocklistUrl)&&(identical(other.cacheSizeMb, _this.cacheSizeMb) || other.cacheSizeMb == _this.cacheSizeMb)&&(identical(other.configDir, _this.configDir) || other.configDir == _this.configDir)&&(identical(other.defaultTrackers, _this.defaultTrackers) || other.defaultTrackers == _this.defaultTrackers)&&(identical(other.dhtEnabled, _this.dhtEnabled) || other.dhtEnabled == _this.dhtEnabled)&&(identical(other.downloadDir, _this.downloadDir) || other.downloadDir == _this.downloadDir)&&(identical(other.downloadDirFreeSpace, _this.downloadDirFreeSpace) || other.downloadDirFreeSpace == _this.downloadDirFreeSpace)&&(identical(other.downloadQueueEnabled, _this.downloadQueueEnabled) || other.downloadQueueEnabled == _this.downloadQueueEnabled)&&(identical(other.downloadQueueSize, _this.downloadQueueSize) || other.downloadQueueSize == _this.downloadQueueSize)&&(identical(other.encryption, _this.encryption) || other.encryption == _this.encryption)&&(identical(other.idleSeedingLimit, _this.idleSeedingLimit) || other.idleSeedingLimit == _this.idleSeedingLimit)&&(identical(other.idleSeedingLimitEnabled, _this.idleSeedingLimitEnabled) || other.idleSeedingLimitEnabled == _this.idleSeedingLimitEnabled)&&(identical(other.incompleteDir, _this.incompleteDir) || other.incompleteDir == _this.incompleteDir)&&(identical(other.incompleteDirEnabled, _this.incompleteDirEnabled) || other.incompleteDirEnabled == _this.incompleteDirEnabled)&&(identical(other.lpdEnabled, _this.lpdEnabled) || other.lpdEnabled == _this.lpdEnabled)&&(identical(other.peerLimitGlobal, _this.peerLimitGlobal) || other.peerLimitGlobal == _this.peerLimitGlobal)&&(identical(other.peerLimitPerTorrent, _this.peerLimitPerTorrent) || other.peerLimitPerTorrent == _this.peerLimitPerTorrent)&&(identical(other.peerPort, _this.peerPort) || other.peerPort == _this.peerPort)&&(identical(other.peerPortRandomOnStart, _this.peerPortRandomOnStart) || other.peerPortRandomOnStart == _this.peerPortRandomOnStart)&&(identical(other.pexEnabled, _this.pexEnabled) || other.pexEnabled == _this.pexEnabled)&&(identical(other.portForwardingEnabled, _this.portForwardingEnabled) || other.portForwardingEnabled == _this.portForwardingEnabled)&&(identical(other.queueStalledEnabled, _this.queueStalledEnabled) || other.queueStalledEnabled == _this.queueStalledEnabled)&&(identical(other.queueStalledMinutes, _this.queueStalledMinutes) || other.queueStalledMinutes == _this.queueStalledMinutes)&&(identical(other.renamePartialFiles, _this.renamePartialFiles) || other.renamePartialFiles == _this.renamePartialFiles)&&(identical(other.scriptTorrentAddedEnabled, _this.scriptTorrentAddedEnabled) || other.scriptTorrentAddedEnabled == _this.scriptTorrentAddedEnabled)&&(identical(other.scriptTorrentAddedFilename, _this.scriptTorrentAddedFilename) || other.scriptTorrentAddedFilename == _this.scriptTorrentAddedFilename)&&(identical(other.scriptTorrentDoneEnabled, _this.scriptTorrentDoneEnabled) || other.scriptTorrentDoneEnabled == _this.scriptTorrentDoneEnabled)&&(identical(other.scriptTorrentDoneFilename, _this.scriptTorrentDoneFilename) || other.scriptTorrentDoneFilename == _this.scriptTorrentDoneFilename)&&(identical(other.scriptTorrentDoneSeedingEnabled, _this.scriptTorrentDoneSeedingEnabled) || other.scriptTorrentDoneSeedingEnabled == _this.scriptTorrentDoneSeedingEnabled)&&(identical(other.scriptTorrentDoneSeedingFilename, _this.scriptTorrentDoneSeedingFilename) || other.scriptTorrentDoneSeedingFilename == _this.scriptTorrentDoneSeedingFilename)&&(identical(other.seedQueueEnabled, _this.seedQueueEnabled) || other.seedQueueEnabled == _this.seedQueueEnabled)&&(identical(other.seedQueueSize, _this.seedQueueSize) || other.seedQueueSize == _this.seedQueueSize)&&(identical(other.seedRatioLimit, _this.seedRatioLimit) || other.seedRatioLimit == _this.seedRatioLimit)&&(identical(other.seedRatioLimited, _this.seedRatioLimited) || other.seedRatioLimited == _this.seedRatioLimited)&&(identical(other.sessionId, _this.sessionId) || other.sessionId == _this.sessionId)&&(identical(other.speedLimitDown, _this.speedLimitDown) || other.speedLimitDown == _this.speedLimitDown)&&(identical(other.speedLimitDownEnabled, _this.speedLimitDownEnabled) || other.speedLimitDownEnabled == _this.speedLimitDownEnabled)&&(identical(other.speedLimitUp, _this.speedLimitUp) || other.speedLimitUp == _this.speedLimitUp)&&(identical(other.speedLimitUpEnabled, _this.speedLimitUpEnabled) || other.speedLimitUpEnabled == _this.speedLimitUpEnabled)&&(identical(other.startAddedTorrents, _this.startAddedTorrents) || other.startAddedTorrents == _this.startAddedTorrents)&&(identical(other.tcpEnabled, _this.tcpEnabled) || other.tcpEnabled == _this.tcpEnabled)&&(identical(other.trashOriginalTorrentFiles, _this.trashOriginalTorrentFiles) || other.trashOriginalTorrentFiles == _this.trashOriginalTorrentFiles)&&(identical(other.utpEnabled, _this.utpEnabled) || other.utpEnabled == _this.utpEnabled));
}
...
int get hashCode {
  final _this = this as TransmissionPreferences;
  return Object.hashAll([runtimeType,_this.rpcVersion,_this.rpcVersionSemver,_this.rpcVersionMinimum,_this.version,_this.altSpeedDown,_this.altSpeedEnabled,_this.altSpeedTimeBegin,_this.altSpeedTimeDay,_this.altSpeedTimeEnabled,_this.altSpeedTimeEnd,_this.altSpeedUp,_this.antiBruteForceEnabled,_this.antiBruteForceThreshold,_this.blocklistEnabled,_this.blocklistSize,_this.blocklistUrl,_this.cacheSizeMb,_this.configDir,_this.defaultTrackers,_this.dhtEnabled,_this.downloadDir,_this.downloadDirFreeSpace,_this.downloadQueueEnabled,_this.downloadQueueSize,_this.encryption,_this.idleSeedingLimit,_this.idleSeedingLimitEnabled,_this.incompleteDir,_this.incompleteDirEnabled,_this.lpdEnabled,_this.peerLimitGlobal,_this.peerLimitPerTorrent,_this.peerPort,_this.peerPortRandomOnStart,_this.pexEnabled,_this.portForwardingEnabled,_this.queueStalledEnabled,_this.queueStalledMinutes,_this.renamePartialFiles,_this.scriptTorrentAddedEnabled,_this.scriptTorrentAddedFilename,_this.scriptTorrentDoneEnabled,_this.scriptTorrentDoneFilename,_this.scriptTorrentDoneSeedingEnabled,_this.scriptTorrentDoneSeedingFilename,_this.seedQueueEnabled,_this.seedQueueSize,_this.seedRatioLimit,_this.seedRatioLimited,_this.sessionId,_this.speedLimitDown,_this.speedLimitDownEnabled,_this.speedLimitUp,_this.speedLimitUpEnabled,_this.startAddedTorrents,_this.tcpEnabled,_this.trashOriginalTorrentFiles,_this.utpEnabled]);
}

@override
String toString() {
  final _this = this as TransmissionPreferences;
  return 'TransmissionPreferences(rpcVersion: ${_this.rpcVersion}, rpcVersionSemver: ${_this.rpcVersionSemver}, rpcVersionMinimum: ${_this.rpcVersionMinimum}, version: ${_this.version}, altSpeedDown: ${_this.altSpeedDown}, altSpeedEnabled: ${_this.altSpeedEnabled}, altSpeedTimeBegin: ${_this.altSpeedTimeBegin}, altSpeedTimeDay: ${_this.altSpeedTimeDay}, altSpeedTimeEnabled: ${_this.altSpeedTimeEnabled}, altSpeedTimeEnd: ${_this.altSpeedTimeEnd}, altSpeedUp: ${_this.altSpeedUp}, antiBruteForceEnabled: ${_this.antiBruteForceEnabled}, antiBruteForceThreshold: ${_this.antiBruteForceThreshold}, blocklistEnabled: ${_this.blocklistEnabled}, blocklistSize: ${_this.blocklistSize}, blocklistUrl: ${_this.blocklistUrl}, cacheSizeMb: ${_this.cacheSizeMb}, configDir: ${_this.configDir}, defaultTrackers: ${_this.defaultTrackers}, dhtEnabled: ${_this.dhtEnabled}, downloadDir: ${_this.downloadDir}, downloadDirFreeSpace: ${_this.downloadDirFreeSpace}, downloadQueueEnabled: ${_this.downloadQueueEnabled}, downloadQueueSize: ${_this.downloadQueueSize}, encryption: ${_this.encryption}, idleSeedingLimit: ${_this.idleSeedingLimit}, idleSeedingLimitEnabled: ${_this.idleSeedingLimitEnabled}, incompleteDir: ${_this.incompleteDir}, incompleteDirEnabled: ${_this.incompleteDirEnabled}, lpdEnabled: ${_this.lpdEnabled}, peerLimitGlobal: ${_this.peerLimitGlobal}, peerLimitPerTorrent: ${_this.peerLimitPerTorrent}, peerPort: ${_this.peerPort}, peerPortRandomOnStart: ${_this.peerPortRandomOnStart}, pexEnabled: ${_this.pexEnabled}, portForwardingEnabled: ${_this.portForwardingEnabled}, queueStalledEnabled: ${_this.queueStalledEnabled}, queueStalledMinutes: ${_this.queueStalledMinutes}, renamePartialFiles: ${_this.renamePartialFiles}, scriptTorrentAddedEnabled: ${_this.scriptTorrentAddedEnabled}, scriptTorrentAddedFilename: ${_this.scriptTorrentAddedFilename}, scriptTorrentDoneEnabled: ${_this.scriptTorrentDoneEnabled}, scriptTorrentDoneFilename: ${_this.scriptTorrentDoneFilename}, scriptTorrentDoneSeedingEnabled: ${_this.scriptTorrentDoneSeedingEnabled}, scriptTorrentDoneSeedingFilename: ${_this.scriptTorrentDoneSeedingFilename}, seedQueueEnabled: ${_this.seedQueueEnabled}, seedQueueSize: ${_this.seedQueueSize}, seedRatioLimit: ${_this.seedRatioLimit}, seedRatioLimited: ${_this.seedRatioLimited}, sessionId: ${_this.sessionId}, speedLimitDown: ${_this.speedLimitDown}, speedLimitDownEnabled: ${_this.speedLimitDownEnabled}, speedLimitUp: ${_this.speedLimitUp}, speedLimitUpEnabled: ${_this.speedLimitUpEnabled}, startAddedTorrents: ${_this.startAddedTorrents}, tcpEnabled: ${_this.tcpEnabled}, trashOriginalTorrentFiles: ${_this.trashOriginalTorrentFiles}, utpEnabled: ${_this.utpEnabled})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? rpcVersion = null,Object? rpcVersionSemver = null,Object? rpcVersionMinimum = null,Object? version = null,Object? altSpeedDown = null,Object? altSpeedEnabled = null,Object? altSpeedTimeBegin = null,Object? altSpeedTimeDay = null,Object? altSpeedTimeEnabled = null,Object? altSpeedTimeEnd = null,Object? altSpeedUp = null,Object? antiBruteForceEnabled = null,Object? antiBruteForceThreshold = null,Object? blocklistEnabled = null,Object? blocklistSize = null,Object? blocklistUrl = null,Object? cacheSizeMb = null,Object? configDir = null,Object? defaultTrackers = null,Object? dhtEnabled = null,Object? downloadDir = null,Object? downloadDirFreeSpace = null,Object? downloadQueueEnabled = null,Object? downloadQueueSize = null,Object? encryption = null,Object? idleSeedingLimit = null,Object? idleSeedingLimitEnabled = null,Object? incompleteDir = null,Object? incompleteDirEnabled = null,Object? lpdEnabled = null,Object? peerLimitGlobal = null,Object? peerLimitPerTorrent = null,Object? peerPort = null,Object? peerPortRandomOnStart = null,Object? pexEnabled = null,Object? portForwardingEnabled = null,Object? queueStalledEnabled = null,Object? queueStalledMinutes = null,Object? renamePartialFiles = null,Object? scriptTorrentAddedEnabled = null,Object? scriptTorrentAddedFilename = null,Object? scriptTorrentDoneEnabled = null,Object? scriptTorrentDoneFilename = null,Object? scriptTorrentDoneSeedingEnabled = null,Object? scriptTorrentDoneSeedingFilename = null,Object? seedQueueEnabled = null,Object? seedQueueSize = null,Object? seedRatioLimit = null,Object? seedRatioLimited = null,Object? sessionId = null,Object? speedLimitDown = null,Object? speedLimitDownEnabled = null,Object? speedLimitUp = null,Object? speedLimitUpEnabled = null,Object? startAddedTorrents = null,Object? tcpEnabled = null,Object? trashOriginalTorrentFiles = null,Object? utpEnabled = null,}) {
  return _then(TransmissionPreferences(
