...
bool operator ==(Object other) {
  final _this = this as ManagedUser;
...
String toString() {
  final _this = this as ManagedUser;
  return 'ManagedUser(id: ${_this.id}, username: ${_this.username}, isActive: ${_this.isActive}, isStaff: ${_this.isStaff}, isSuperuser: ${_this.isSuperuser}, email: ${_this.email})';
}
...
@override
bool operator ==(Object other) {
  final _this = this as UserCredentials;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserCredentials&&(identical(other.username, _this.username) || other.username == _this.username)&&(identical(other.password, _this.password) || other.password == _this.password));
}
...
String toString() {
  final _this = this as UserCredentials;
  return 'UserCredentials(username: ${_this.username}, password: ${_this.password})';
}
